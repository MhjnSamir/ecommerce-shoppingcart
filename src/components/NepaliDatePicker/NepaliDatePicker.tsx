...
import { INepaliDatePicker, NepaliDatepickerEvents, childOf, stitchDate, ADToBS, BSToAD } from "./Datepickerutils"
import "./Datepicker.scss"


const NepaliDatePicker = (props: INepaliDatePicker) => {
    const { wrapperClassName, className = "form-control", value, engDate, onChange, onSelect, options = {}, closeOnSelect = true, maxDate, maxDateToday, minDate, minDateToday, id, name} = props;
